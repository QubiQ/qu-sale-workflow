    ...
    def _get_price_reduce(self):
        for line in self:
            ...
            if line.order_id.pricelist_id.discount_policy == 'with_discount':
                temp_discount =\
                 temp_discount * (1.0-(line.base_discount/100.0))
            if line.discount1 != 0.0:
                temp_discount = temp_discount * (1.0-(line.discount1/100.0))
            if line.discount2 != 0.0:
                temp_discount = temp_discount * (1.0-(line.discount2/100.0))
            if line.discount3 != 0.0:
                temp_discount = temp_discount * (1.0-(line.discount3/100.0))
